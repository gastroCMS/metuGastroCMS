...
export function AuthModal({ isOpen, onClose, onSuccess }: AuthModalProps) {
  ...
  const translateAuthError = (unknownError: unknown): string => {
    const fallback = 'Bir hata oluştu';
    if (!(unknownError instanceof Error)) return fallback;
    const message = unknownError.message || fallback;
      ...
      <div className="bg-white rounded-lg max-w-md w-full p-6">
        ...
        <div className="mt-4">
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 bg-white border border-gray-300 text-gray-700 py-2 px-4 rounded-md hover:bg-gray-50"
          >
